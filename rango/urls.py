...
urlpatterns = patterns('',
    ...
    url(r'^pages/(?P<page_id>\d+)/$', views.detail, name='detail'),
    url(r'^about/$', views.about, name='about'),
    url(r'^categories/([a-z0-9-]+)/$', views.category, name='category'),
    ...
    url(r'^newcategory/$', views.add_category, name='newcategory'),
)
