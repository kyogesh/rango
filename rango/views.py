...
def detail(request, page_id):
    ...
    page.save()
    categories = list_categories()
    return render(request, 'rango/page_detail.html', {'page':page, 'categories':categories})
...
def category(request, cat_slug):
    ...
    return render(request, 'rango/category_detail.html',{'cat':cat, 'categories':categories})


def list_pages(request):
    pages = Page.objects.all()
    categories = list_categories()
    return render(request, 'rango/pages.html', {'pages':pages, 'categories':categories})
...
def signin(request):
    ...
    # If t]he request is a HTTP POST, try to pull out the relevant information.
    if request.method == 'POST':
    ...
    # This scenario would most likely be a HTTP GET.
        ...
        categories = list_categories()
        return render_to_response('rango/login.html', {'categories':categories}, RequestContext(request))
...
def add_page(request):
    ...
    if request.method=='POST':
        ...
        if new_form.is_valid:
            ...
            new_page.save()
            return HttpResponseRedirect(reverse('rango:detail', args=(new_page.id,)))
        else:
            new_form.errors
    else:
        new_form = PageForm()
    ...
    categories = list_categories()
    return render(request, 'rango/add_page.html', {'new_form':new_form, 'categories': categories})
...
def add_category(request):
    ...
    if request.method=='POST':
        ...
        if new_form.is_valid():
            ...
            return HttpResponseRedirect(reverse('rango:category', args=(new_category.slug,)))
        else:
            new_form.errors
    else:
    ...
    categories = list_categories()
    return render(request, 'rango/add_category.html', {'new_form':new_form, 'categories': categories})